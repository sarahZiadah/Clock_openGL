...
int main()
{
	...
	Polygon rodF = Polygon(rodFront, vec3(0.5f, 0.2f, 0.1f));
	...
	Polygon rodB = Polygon(rodBack, vec3(0.5f, 0.3f, 0.15f));
	...
	Polygon rodL = Polygon(rodLeft, vec3(0.5f, 0.3f, 0.15f));
	...
	Polygon rodR = Polygon(rodRight, vec3(0.6f, 0.3f, 0.15f));
	...
	Polygon rodT = Polygon(rodTop, vec3(0.6f, 0.3f, 0.15f));
	...
	Polygon rodD = Polygon(rodBottom, vec3(0.6f, 0.3f, 0.15f));
